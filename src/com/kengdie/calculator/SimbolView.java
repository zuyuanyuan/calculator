...
public class SimbolView extends KeyView{
	...
	public SimbolView(Context context) {
		this(context, null);
	}

	public SimbolView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SimbolView(Context context, AttributeSet attrs, int defStyle) {
